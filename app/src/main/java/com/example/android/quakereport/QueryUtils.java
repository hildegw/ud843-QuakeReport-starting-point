...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthQuakeEntry> extractEarthquakes(Activity context) {
        ...
        try {
            JSONObject jsonEQRoot = new JSONObject(SAMPLE_JSON_RESPONSE);
